...
export const EmptyState = () => {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
      <div className="w-24 h-24 rounded-full bg-white/40 glass flex items-center justify-center mb-8 relative">
      ...
      <h3 className="text-2xl font-bold text-gray-900 mb-3 tracking-tight">Your Messages</h3>
